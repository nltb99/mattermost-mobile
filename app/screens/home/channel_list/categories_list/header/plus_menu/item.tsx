    ...
    const menuItems = {
        browseChannels: {
            ...
            text: intl.formatMessage({
                id: 'plus_menu.browse_channels.title',
        ...
        createNewChannel: {
            icon: 'plus',
            text: intl.formatMessage({
                id: 'plus_menu.create_new_channel.title',
        ...
        openDirectMessage: {
            ...
            text: intl.formatMessage({
                id: 'plus_menu.open_direct_message.title',
        ...
        invitePeopleToTeam: {
            ...
            text: intl.formatMessage({
                id: 'plus_menu.invite_people_to_team.title',
        ...
        refreshApp: {
            icon: 'update',
            text: intl.formatMessage({
                id: 'application.refresh_app',
                defaultMessage: 'Refresh Application',
            }),
        },
    };
