...
import {CREATE_ACCOUNT, FORGOT_PASSWORD, MFA} from '@constants/screens';
...
export const MFA_EXPECTED_ERRORS = [
...
const LoginForm = ({
    ...
    const signIn = async () => {
        const result: LoginActionResponse = await login(serverUrl!, {
            serverDisplayName,
            loginId: loginId.toLowerCase(),
            password,
            config,
    ...
    const getLoginErrorMessage = (
        loginError: string | ClientErrorProps | Error,
    ) => {
    ...
    const onPressDontHaveAccount = useCallback(() => {
        ...
        goToScreen(CREATE_ACCOUNT, '', passProps, loginAnimationOptions());
    }, [theme]);
        ...
        <View style={styles.container}>
            ...
            >
                ...
                {(emailEnabled || usernameEnabled) && (
                    ...
                    >
                        <FormattedText
                            id='mobile.account.dont_have_account'
