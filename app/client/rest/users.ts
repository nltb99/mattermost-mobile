...
export interface ClientUsersMix {
    ...
    patchUser: (
        userPatch: Partial<UserProfile> & {id: string}
    ) => Promise<UserProfile>;
    ...
    autocompleteUsers: (
        ...
        channelId?: string,
        options?: Record<string, any>
    ) => Promise<{users: UserProfile[]; out_of_channel?: UserProfile[]}>;
...
const ClientUsers = <TBase extends Constructor<ClientBase>>(
    superclass: TBase,
) =>
        class extends superclass {
            ...
            patchUser = async (userPatch: Partial<UserProfile> & {id: string}) => {
                ...
                return this.doFetch(`${this.getUserRoute(userPatch.id)}/patch`, {
                    method: 'put',
                    body: userPatch,
                });
            };
            ...
            updateUser = async (user: UserProfile) => {
                ...
                return this.doFetch(`${this.getUserRoute(user.id)}`, {
                    method: 'put',
                    body: user,
                });
            };
            ...
            demoteUserToGuest = async (userId: string) => {
                ...
                return this.doFetch(`${this.getUserRoute(userId)}/demote`, {
                    method: 'post',
                });
            };
            ...
            getKnownUsers = async () => {
                ...
                return this.doFetch(`${this.getUsersRoute()}/known`, {
                    method: 'get',
                });
            };
            ...
            sendPasswordResetEmail = async (email: string) => {
                ...
                return this.doFetch(`${this.getUsersRoute()}/password/reset/send`, {
                    method: 'post',
                    body: {email},
                });
            };

            sendCreateAccountRequest = async (
                email: string,
                username: string,
                password: string,
                teamCode: string,
            ...
            getProfilesByUsernames = async (usernames: string[]) => {
                ...
                return this.doFetch(`${this.getUsersRoute()}/usernames`, {
                    method: 'post',
                    body: usernames,
                });
            };

            getProfilesInTeam = async (
                teamId: string,
                page = 0,
                perPage = PER_PAGE_DEFAULT,
                sort = '',
                ...
                this.analytics?.trackAPI('api_profiles_get_in_team', {
                    team_id: teamId,
                    sort,
                });
            ...
            getProfilesNotInTeam = async (
                teamId: string,
                groupConstrained: boolean,
                page = 0,
                perPage = PER_PAGE_DEFAULT,
            ) => {
                this.analytics?.trackAPI('api_profiles_get_not_in_team', {
                    team_id: teamId,
            ...
            getProfilesInChannel = async (
                channelId: string,
                options: GetUsersOptions,
            ) => {
                this.analytics?.trackAPI('api_profiles_get_in_channel', {
            ...
            getProfilesInGroupChannels = async (channelsIds: string[]) => {
                this.analytics?.trackAPI('api_profiles_get_in_group_channels', {
                    channelsIds,
                });

                return this.doFetch(`${this.getUsersRoute()}/group_channels`, {
                    method: 'post',
                    body: channelsIds,
                });
            };

            getProfilesNotInChannel = async (
                teamId: string,
                channelId: string,
                groupConstrained: boolean,
                page = 0,
                ...
                this.analytics?.trackAPI('api_profiles_get_not_in_channel', {
                    team_id: teamId,
                    channel_id: channelId,
                    group_constrained: groupConstrained,
                });
            ...
            getUser = async (userId: string) => {
                return this.doFetch(`${this.getUserRoute(userId)}`, {
                    method: 'get',
                });
            };
            ...
            getUserByEmail = async (email: string) => {
                return this.doFetch(`${this.getUsersRoute()}/email/${email}`, {
                    method: 'get',
                });
            };
            ...
            getProfilePictureUrl = (userId: string, lastPictureUpdate: number) => {
                ...
                return `${this.getUserRoute(userId)}/image${buildQueryString(
                    params,
                )}`;
            };
            ...
            getSessions = async (userId: string) => {
                return this.doFetch(`${this.getUserRoute(userId)}/sessions`, {
                    method: 'get',
                    headers: {'Cache-Control': 'no-store'},
                });
            };
            ...
            checkUserMfa = async (loginId: string) => {
                return this.doFetch(`${this.getUsersRoute()}/mfa`, {
                    method: 'post',
            ...
            attachDevice = async (deviceId: string) => {
                return this.doFetch(`${this.getUsersRoute()}/sessions/device`, {
                    method: 'put',
            ...
            searchUsers = async (term: string, options: any) => {
                ...
                return this.doFetch(`${this.getUsersRoute()}/search`, {
                    method: 'post',
                    body: {term, ...options},
                });
            };
            ...
            getStatusesByIds = async (userIds: string[]) => {
                return this.doFetch(`${this.getUsersRoute()}/status/ids`, {
                    method: 'post',
                    body: userIds,
                });
            };
            ...
            getStatus = async (userId: string) => {
                return this.doFetch(`${this.getUserRoute(userId)}/status`, {
                    method: 'get',
                });
            };

            updateStatus = async (status: UserStatus) => {
                return this.doFetch(`${this.getUserRoute(status.user_id)}/status`, {
                    method: 'put',
                    body: status,
                });
            };
